  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          {[
            { href: "https://github.com/mhrdkaa", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://www.linkedin.com/in/putra-mahardika-bb7591298", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" },
            { href: "mailto:denputra.mahardika@gmail.com", icon: "material-icon-theme:email", label: "Email", color: "hover:text-green-600" }
          ].map((link) => (
