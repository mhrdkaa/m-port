...
const experience = [
  {
    ...
    technologies: ["Postman", "Python", "Node.js", "Burpsuite", "Graphql"]
  }
];
    ...
    >
      ...
      <div className="relative z-10">
        <SectionHeader
          ...
          heading="Pengalaman"
          showUnderline={false}
          description="Perjalanan profesional saya dan dampak yang telah saya buat di berbagai bidang."
          centered={true}
        />
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="text-gray-600 dark:text-gray-400 font-medium text-base md:text-lg">HOF on Company</div>
            </motion.div>
