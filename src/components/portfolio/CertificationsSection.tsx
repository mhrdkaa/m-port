...
const certifications: Certificate[] = [
  {
    title: "Juara 2 IOT",
    provider: "INDONERIS National 2025",
    platform: "Universitas Amikom Purwokerto",
    issued: "November 2024",
    skills: ["IoT", "PostgreSQL", "Product Development", "Web Development", "Python"],
    color: "from-blue-500 to-blue-600",
    certificatePreview: "/certificates/indoneris.png",
    providerIconSize: 64,
    platformIconSize: 88
  }
];
                  ...
                  <div className="p-6 relative">
                    ...
                    <div className="space-y-3 mb-6 bg-gray-50/50 dark:bg-gray-800/30 rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/30">
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium">Penyedia:</span>
                      ...
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium">Penyelenggara:</span>
                      ...
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium">Rilis:</span>
