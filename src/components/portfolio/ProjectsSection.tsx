...
const projects = [
  {
    ...
    subtitle: "Aplikasi Pemesanan Makanan Modern dengan Integrasi Midtrans",
    description: "Sistem pemesanan dan pembayaran berbasis web untuk Pancong Abidzar yang dibangun menggunakan Laravel, React, dan Midtrans. Pelanggan cukup memindai QR code untuk mengakses menu, memilih item, menentukan opsi makan di tempat atau dibawa pulang, lalu menyelesaikan pembayaran melalui QRIS, Midtrans, atau tunai. Sistem ini menyederhanakan proses pemesanan dan meningkatkan kenyamanan pelanggan.",
    features: [
    ...
    tech: ["React.JS", "Laravel", "Tailwind CSS", "MySQL", "Midtrans"],
    github: "https://github.com/mhrdkaa/PEWEL",
    // live: "https://checkersvip.com",
    gradient: "from-yellow-500 to-brown-300",
    status: "Off",
    category: "Web Application",
    highlight: "Featured",
    timeline: "2 months",
    clientType: "UMKM Industry"
  },
  {
    title: "Lokal ChatBOT Ollama",
    subtitle: "Web Seperti ChatGPT menggunakan OLLAMA",
    description: "Web Lokal AI berbasis Ollama DeepSeek-R1 memungkinkan pengguna berinteraksi dengan AI secara real-time, menyimpan riwayat percakapan, dan meninjau chat sebelumnya dengan aman. Setiap percakapan dicatat dengan metadata penting dan dilindungi enkripsi, menciptakan pengalaman chat yang responsif dan aman di lingkungan lokal.",
    features: [
    ...
    tech: ["Vite.JS", "TypeScript", "Tailwind CSS", "Radix UI", "Dexie", "zod"],
    github: "https://github.com/mhrdkaa/local-ollama",
    // live: "https://checkersvip.com",
    gradient: "from-blue-500 to-white-200",
    status: "Off",
    category: "Web Application",
    highlight: "Featured",
    timeline: "2 months",
  ...
  {
    title: "Store DISCORD",
    subtitle: "Virtual Store Bot",
    description: "Virtual Store Bot adalah bot Discord yang berfungsi sebagai kasir digital. Bot ini memungkinkan pengguna untuk menambahkan saldo, membeli item atau layanan, dan melacak transaksi secara otomatis, sehingga seluruh proses jual-beli di server dapat dilakukan dengan cepat dan aman tanpa intervensi manual.",
    features: [
    ...
    tech: ["Express.JS", "NodeJs", "MongoDB"],
    github: "https://github.com/mhrdkaa/DENSTORE",
    // live: "https://checkersvip.com",
    gradient: "from-blue-500 to-black-500",
    status: "Off",
    category: "Chat-based Application",
    highlight: "Featured",
    timeline: "2 months",
    clientType: "UMKM Industry"
  },
    ...
    >
      ...
      >
        ...
        <SectionHeader
          ...
          heading="Projects"
          description="Karya terbaru saya dalam pengembangan web, integrasi AI, dan inovasi digital."
          showUnderline={true}
          centered={true}
        />
                ...
                <div className="p-4 sm:p-6 md:p-8 lg:p-10">
                  ...
                  <div className="mt-6 md:mt-8 lg:mt-12 pt-6 md:pt-8 border-t border-gray-200/50 dark:border-gray-700/50">
                    <h4 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-4 md:mb-6 flex items-center gap-2 md:gap-3">
                      ...
                      <span>Teknologi yang di pakai</span>
                    </h4>
